...
class CFG:
    ...
    model_name = 'convnext_large_exp_002_forward'
    V = '6'
...
def get_loaders():
    ...
    train_files = training_files.copy()
    valid_files = validation_files.copy()
...
class Model(nn.Module):
    def __init__(self, checkpoint_file=1):
        ...
        self.dec4 = UnetBlock(1536, 768, 1280)
        self.dec3 = UnetBlock(1280, 384, 640)
        self.dec2 = UnetBlock(640, 192, 320)
        self.fpn = FPN([1536, 1280, 640], [64]*3)
        self.final_conv = nn.Sequential(UpBlock(320+64*3, num_classes, blur=True))
...
miou, outputs, targets, ids = valid_one_epoch(f"/mnt/md0/dacl10k/AAA_MMSEG/TRY1_SEG/convnext_large_exp_002_forward_v3/0_best.pth", valid_loader, debug=True, running_dist=False)
