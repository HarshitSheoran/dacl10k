...
miou, outputs, targets, ids = valid_one_epoch(f"/mnt/md0/dacl10k/AAA_MMSEG/TRY1_SEG/eva_02_large_exp_001_v2/0_best.pth", valid_loader, debug=True, running_dist=False)
