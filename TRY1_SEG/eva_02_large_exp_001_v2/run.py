...
miou, outputs, targets, ids = valid_one_epoch(f"/mnt/md0/dacl10k/AAA_MMSEG/TRY1_SEG/eva_02_large_exp_001_v1/0_best.pth", valid_loader, debug=True, running_dist=False)
...
#v5 (640x640) -> 0.43756302751846804
#v6 (640x640) -> 0.44192072058937776
#v6 (512x512) -> 0.44020324686364115
#eca v1 (512x512) e7 -> 0.45057784471179047
#eca v1 (512x512) e11 -> 0.4521060549505043
